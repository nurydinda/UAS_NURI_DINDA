...
<div class="p-4 mt-4">
     ...
     <form action="" method="post" class="mt-5">
       ...
       <div class="card" style="width: 15rem;">
        ...
        <div class="card-body">
          <a class="btn btn-success" href="updateBuku.php?idReview=<?= $item["kodebuku"]; ?>" id="review">Edit</a>
          
          <a class="btn btn-danger" href="deleteBuku.php?id=<?= $item["kodebuku"]; ?>" onclick="return confirm('Yakin ingin menghapus data buku ? ');">Delete</a>
          </div>
        </div>
       <?php endforeach; ?>
       </div>
